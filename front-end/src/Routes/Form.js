    ...
    return (
        <div className="form">
          ...
          <form onSubmit={(e) => {
            ...
            <input type="text" value={building} required onChange={(e) => {
              handleBuilding(e)
            }}/><br/>
            <label>
              Room Location:
            </label><br/>
            <input type="text" value={room} required onChange={(e) => {
              handleRoom(e)
            }}/><br/>
            <label>
              Issue:
            </label><br/>
            <input type="text" value={issue} required onChange={(e) => {
              handleIssue(e)
            }}/><br/>
            <label>
              Comments:
            </label><br/>
            <input type="text" value={comments} required onChange={(e) => {
              handleComments(e)
            }}/><br/>
            <label>
              Problem:
